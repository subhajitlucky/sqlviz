    ...
    <div className="w-full h-64 bg-slate-100 dark:bg-slate-950 rounded-xl border border-slate-300 dark:border-slate-800 relative overflow-hidden flex flex-col items-center justify-center p-6 transition-colors shadow-sm">
      <svg className="w-full h-full" viewBox="0 0 100 60">
        ...
        <motion.circle
          cx="85" cy="50" r="3"
          fill="currentColor"
          className="text-sapphire-600 dark:text-sapphire-500"
      ...
      <div className="absolute top-4 left-4 font-mono">
        <div className="text-[10px] text-slate-400 dark:text-slate-500 uppercase">Search Key</div>
        <div className="text-xs text-sapphire-600 dark:text-sapphire-400 font-bold">VAL: 180</div>
      </div>
