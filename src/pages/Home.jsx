  ...
  return (
    <div className="flex-grow relative flex flex-col items-center justify-center overflow-hidden py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {/* System Status Badge */}
          <motion.div variants={itemVariants} className="inline-flex items-center space-x-3 px-4 py-1.5 rounded-full bg-db-surface border border-db-border text-sql-cyan text-[10px] font-black uppercase tracking-[0.2em] mb-12 shadow-[0_0_15px_rgba(0,229,255,0.1)]">
