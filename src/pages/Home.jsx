    ...
    <div className="flex-grow relative flex flex-col items-center justify-center overflow-hidden py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.div 
            variants={itemVariants}
            className="mt-40 grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-200 dark:bg-db-border border border-slate-200 dark:border-db-border shadow-2xl"
          >
            {[
              ...
              <div key={i} className="p-10 bg-white dark:bg-db-surface text-left hover:bg-slate-50 dark:hover:bg-db-panel transition-all group">
