  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden transition-colors duration-300">
      <div className="flex-grow grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="bg-slate-100 dark:bg-slate-900 flex flex-col overflow-hidden">
          ...
          <div className="flex-grow p-8 flex flex-col items-center justify-start space-y-8 overflow-y-auto">
            <div className="grid grid-cols-2 gap-8 w-full max-w-2xl">
              {tables.map((table) => (
                <div key={table.name} className="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden bg-white dark:bg-slate-950 shadow-lg">
                  <div className="bg-slate-50 dark:bg-slate-800 px-3 py-1 flex items-center space-x-2 border-b border-slate-200 dark:border-slate-700">
            ...
            <AnimatePresence>
              {resultRows.length > 0 && (
                <motion.div 
                  ...
                  className="w-full max-w-2xl border border-emerald-500/30 rounded-lg overflow-hidden bg-white dark:bg-slate-950 shadow-2xl"
                >
                  <div className="bg-emerald-50 dark:bg-emerald-900/20 px-3 py-1 flex items-center justify-between border-b border-emerald-500/30">
